...
let yryz = {
	// 更多
	moreAction: sdk.registerNative("moreAction"),
	// 举报
	report: sdk.registerNative("report"),
	// 发布
	publish: sdk.registerNative("publish"),
	// 打赏
	...
	// 删除资源通知原生
	delete: sdk.registerNative("delete"),
	// 三方分享
	...
	// 跳转原生页面
	router: sdk.registerNative("router"),
	// 获取用户手机已安装的可分享的APP
	...
	// 刷新token
	refreshToken: sdk.registerNative("refreshToken"),
	// 浏览图片
	picturePreview: sdk.registerNative("picturePreview"),
	update: sdk.registerNative("update"),
	// 是否为原生环境
